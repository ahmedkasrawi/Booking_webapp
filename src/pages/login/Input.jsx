  ...
  return (
    <div className="w-full flex flex-col">
      <label className="flex items-center w-full gap-2">
        <span className="w-15 block cursor-pointer">{title}</span>
        <input
          type={type}
          className={`bg-prg/30 border border-gray-400 rounded-md px-2 py-1 shadow-sm shadow-mist-450 ${className}`}
          name={name}
          id={name}
          value={value[name]}
